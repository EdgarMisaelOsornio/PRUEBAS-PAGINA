...
export function generar() {
  ...
  oficinasUnicas.forEach(valorIngresado => {
    ...
    const puestoCompleto = `${puesto} ${oficina.nomenclatura} ${oficina.clave}`;

    out +=
`<span class="puesto-copiable" data-puesto="${puestoCompleto}" title="Clic para copiar el puesto">PUESTO: <strong>${puestoCompleto}</strong> <span class="puesto-copy-icon">📋</span></span>
...
`;
  ...
  document.getElementById("resultado").innerHTML = out.trim();
